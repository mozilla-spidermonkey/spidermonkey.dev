...
* **Summary**: This proposal was two proposals bundled. It introduces a .filterOut method which is
    ...
    example, `[1,2,3].groupBy(x => x > 2)`, would return `[[1,2],[3]]`); GroupBy advanced to stage
    1.
